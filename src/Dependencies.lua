...
gTextures = {
    ['main'] = love.graphics.newImage('graphics/match3-8Colors.png'),
    ['background'] = love.graphics.newImage('graphics/background.png'),
    ['special-tiles'] = love.graphics.newImage('graphics/specialTiles.png'),
...
gFrames = {
    ...
    ['specialTiles'] = GenerateQuadsSpecialTiles(gTextures['special-tiles'])
}
